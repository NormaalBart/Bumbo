...
public class BumboContext : IdentityDbContext<Employee, IdentityRole, string>
{
    ...
    private void SeedBranches(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StandardOpeningHours>().HasData(
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Monday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Tuesday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Wednesday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Thursday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Friday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Saturday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            },
            new StandardOpeningHours
            {
                BranchId = 1, DayOfWeek = DayOfWeek.Sunday, OpenTime = new TimeOnly(8, 00),
                CloseTime = new TimeOnly(20, 00)
            });
    ...
    private void SeedRoles(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
            {
                Id = RoleType.ADMINISTRATOR.RoleId, Name = RoleType.ADMINISTRATOR.Name,
                NormalizedName = RoleType.ADMINISTRATOR.NormalizedName,
                ConcurrencyStamp = "1181a7d7-f073-4d05-b928-cc80f6f5403"
            },
            new IdentityRole
            {
                Id = RoleType.MANAGER.RoleId, Name = RoleType.MANAGER.Name,
                NormalizedName = RoleType.MANAGER.NormalizedName,
                ConcurrencyStamp = "9561f2c3-10ae-4fcf-bba4-2a0fea44eb0f"
            },
            new IdentityRole
            {
                Id = RoleType.EMPLOYEE.RoleId, Name = RoleType.EMPLOYEE.Name,
                NormalizedName = RoleType.EMPLOYEE.NormalizedName,
    ...
    private void SeedShifts(ModelBuilder modelBuilder)
    {
        ...
        var id = SeedShiftMonth(random, workedShift, 1, 1, DateTime.Now);
    ...
    private int SeedShiftMonth(Random random, List<WorkedShift> list, int shiftId, int branchId, DateTime month)
    {
        ...
        foreach (var employee in new[] {"d916944e-c1aa-44d6-83a0-cb04c5734e6b", "1c5d93f8-2965-47a1-89f2-fc626e06949b"})
