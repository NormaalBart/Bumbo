...
namespace BumboData.Migrations
{
    ...
    [Migration("20221215184138_UpdateDayOfWeekFOrmat")]
    partial class UpdateDayOfWeekFOrmat
    {
            ...
            modelBuilder.Entity("BumboData.Models.StandardOpeningHours", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BranchId = 1,
                            DayOfWeek = 1,
                            CloseTime = new DateTime(2022, 12, 15, 20, 0, 0, 0, DateTimeKind.Local),
                            IsClosed = false,
                            OpenTime = new DateTime(2022, 12, 15, 8, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            BranchId = 1,
