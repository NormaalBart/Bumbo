...
public class AvgWorkHoursWeek : CAORuleAppliesToAge
{
    ...
    public AvgWorkHoursWeek(Range ageRange, double maxWeekAvg, int lookAtAmountOfPrevWeeks,
    ...
    public override List<PlannedShift> GetInvalidShifts(List<PlannedShift> plannedShifts)
    {
        ...
        var allWorkedShiftsInTimeframe =
            _plannedShiftsRepository.GetPlannedShiftsInBetween(branchId, employId, startAvgDate,
                firstShiftDateInGivenList);
